...
export default class SearchBar extends Component {
    ...
    autocomplete(player) {
        axios.post('/autocomplete', { input: player.name, pageNum: 1, resultsPerPage: 10 }).then((response) => {
    ...
    render(){
        return (
            <div className='col-xs-11 offset-xl-4 offset-lg-5 col-sm-12 col-md-7 offset-md-5 offset-sm-2'>
