      ...
      <div className="container">
        ...
        <Slider {...settings}>
          <div>
            ...
            <img
              className="mx-auto"
              src={images["featured_gifs/player_search.gif"]}
            />
          </div>
          <div>
            <h1>Player Search</h1>
            <img
              className="mx-auto"
              src={images["featured_gifs/player_results.gif"]}
            />
          </div>
          <div>
            ...
            <img
              className="mx-auto"
              src={images["featured_gifs/h2h_search.gif"]}
            />
          </div>
          <div>
            ...
            <img
              className="mx-auto"
              src={images["featured_gifs/h2h_results.gif"]}
            />
          </div>
        </Slider>
      </div>
