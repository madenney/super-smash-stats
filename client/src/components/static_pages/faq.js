...
const Faq = () => {
    return(
        <div className="container faq">
            ...
            <p>Currently, we have about about 150,000 matches, 400 tournaments, and 22,000 players in the database. Most of it comes from larger scale tournaments because they are easier to pull data from.</p>
