...
class Head2HeadProfile extends Component {
    ...
    render() {
      const {player1, player2, player1wins, player2wins, yearlyHistory,matches} = this.state;
      ...
      if(!player1 || !player2){
        ...
        return(
          <div className='container'>
            <h1>{player1.tag} VERSUS {player2.tag}</h1>
                  ...
                  <div className='row'>
                    ...
                    <div className='col-md-12'>
                      <div className={`${match_active} recent_match col-md-12`} id='tournament_data' >
                        ...
                        <H2HMatchHistory youtube_url_info = {(e)=>this.getYtUrl(e)} matches={this.state.matches}/>
                      </div>
